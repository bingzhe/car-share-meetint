<template>
  <div class="p-stations">
    ...
    <div class="b-search" v-if="gasMode === 1 || gasMode === 2">
      <button
        :class="['btn-item', showOilNumber && 'selected']"
        @click="doToggleOilNumber"
      >
        <span class="mr_10">#{{ searchInfo.oil_numbers }}</span>
        <van-icon
          name="play"
          :class="['icon-arrow', showOilNumber && 'revert']"
        />
      </button>
      <button
        :class="['btn-item', showBrand && 'selected']"
        @click="doToggleBrand"
      >
        <span class="mr_10">{{
          gasStationBrandArray[searchInfo.orderBy - 1].key
        }}</span>
        ...
        <div class="section">
          ...
          <div class="zone-options">
            <div
              ...
              :class="[
                'btn-option',
                searchInfo.oil_numbers === item && 'selected',
              ]"
            >
              {{ item }}#
            </div>
