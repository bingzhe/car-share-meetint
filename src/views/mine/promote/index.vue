<template>
  <div class="container">
    <div class="info-box">
      <div class="t-b">
        ...
        <div class="t-r">
          ...
          <div class="o-info">
            <img
              :src="'@/assets/images/V' + (userData.user_level || 1) + '-s.png'"
              class="l-img"
            />
            <span class="l-txt">
    ...
    <div class="share-btn" @click="doToggleShareMask">
      分享链接给更多人，领取丰厚奖金
    </div>
    <div class="tabs-box">
      <van-tabs
    ...
    <div class="mask" v-if="showShareMask" @click="doToggleShareMask">
      <div class="content">
        <span class="text"
          >点击右上角“...”,
          分享好友或朋友圈邀请好友购买车主卡，成为您的团队成员</span
        >
      </div>
    </div>
  </div>
...
<script>
import inviteList from "@/views/mine/components/inviteList/index";
import fanyongList from "@/views/mine/components/fanyongList/index";
import teamList from "@/views/mine/components/teamList/index";
