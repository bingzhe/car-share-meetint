  ...
  <div>
    <div class="main">
      ...
      <div class="center_box">
        <div class="car_box">
          <img
            :src="require(`@/assets/images/bg_${userData.user_level || 1}.png`)"
            alt
            class="car_img"
          />
          <div class="user-box">
            ...
            <img
              :src="
                require(`@/assets/images/V${userData.user_level || 1}-s.png`)
              "
              class="l-img"
            />
            <span class="l-txt">
        ...
        <div class="i-box">
          ...
          <div
            class="i-mem"
            v-else-if="userData.user_level == 1"
            @click="toXufei"
          >
            <div>开通为会员</div>
...
export default {
  ...
  created() {
    ...
    this.inviteCode =
      this.userInfo && this.userInfo.invite_code
