<template>
  <div class="details_box">
      ...
      <div class="ls_top flexbox">
        <div class="ls_l">
          ...
          <div class="if_stop" v-show="!xcDetail.is_open">
            ...
            <span>营业时间</span>
            <span
              >{{ xcDetail.start_opentime }}--{{ xcDetail.end_opentime }}</span
            >
          </div>
        </div>
        <div class="ls_m">
    ...
    <div
      class="dt_top"
      v-if="!parseInt(xcDetail.isOpen) && parseInt(xcDetail.isStatus) === 4"
    >
      <div class="dt_time">
        营业时间 {{ xcDetail.openTimeStart }}-{{ xcDetail.openTimeEnd }}
      </div>
